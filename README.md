...
# ![app icon](./.github/readme-images/app-icon.png) Komga Enhanced Fork

> **Note: This is an enhanced fork of the original [Komga](https://github.com/gotson/komga) project with additional features and improvements.**

## 🚀 Enhanced Features

- **AI-Powered Meta Books**: Generate comprehensive companion books with in-depth analysis
- **RAG Integration**: Smart search and metadata enhancement using Retrieval-Augmented Generation
- **Calibre Optimization**: Improved integration and performance with Calibre libraries
- **Omnibus Support**: Automatic detection and handling of omnibus editions

---

# Original Komga README
