...
dependencies {
  ...
  // Core DJL dependencies - using 0.15.0 which is compatible with PyTorch 1.9.1
  val djlVersion = "0.15.0"
  implementation("ai.djl:api:$djlVersion")

  // HuggingFace tokenizers
  implementation("ai.djl.huggingface:tokenizers:$djlVersion") {
    exclude(group = "org.bytedeco", module = "*")
  }

  // PyTorch engine with CPU support
  implementation("ai.djl.pytorch:pytorch-engine:$djlVersion") {
    exclude(group = "org.bytedeco", module = "*")
  }

  // PyTorch native libraries (CPU only for compatibility)
  implementation("ai.djl.pytorch:pytorch-native-auto:1.9.1") {
    exclude(group = "org.bytedeco", module = "*")
  }

  // Additional DJL modules
  implementation("ai.djl.pytorch:pytorch-model-zoo:$djlVersion")

  // PyTorch JNI bindings
  implementation("ai.djl.pytorch:pytorch-jni:1.9.1-0.15.0")
