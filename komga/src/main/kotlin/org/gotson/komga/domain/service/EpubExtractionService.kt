...
private fun MediaType.isXml(): Boolean =
  this.subType.equals("xml", ignoreCase = true) ||
    this.subType.endsWith("+xml", ignoreCase = true)

private fun MediaType.isXhtml(): Boolean =
  this.subType.equals("xhtml+xml", ignoreCase = true) ||
