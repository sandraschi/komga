...
object SecurityUtils {
     ...
     */
    @Synchronized
    fun initialize(environment: Environment, propertyName: String = "komga.llm.encryption.key") {
     ...
     */
    fun maskSensitiveString(input: String?, showFirst: Int = 4, showLast: Int = 4, maskChar: Char = '*'): String {
