...
class EpubContentExtractor {
   ...
   */
  fun getResourceContent(resource: Resource): String = String(resource.data, Charsets.UTF_8)
   ...
   */
  fun isCss(href: String): Boolean = href.endsWith(".css", ignoreCase = true)
  ...
  fun isXml(href: String): Boolean =
    href.endsWith(".xml", ignoreCase = true) ||
