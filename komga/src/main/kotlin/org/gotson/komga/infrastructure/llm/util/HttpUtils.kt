...
class HttpUtils(
  ...
  private fun createRetryTemplate(): RetryTemplate {
    ...
    val retryPolicy =
      SimpleRetryPolicy(maxRetries).apply {
  ...
  ): ResponseEntity<T> = executeRequest(HttpMethod.GET, url, null, headers, responseType)
  ...
  fun <T, R> post(
    ...
    headers: Map<String, String> = emptyMap(),
    responseType: Class<T>,
  ): ResponseEntity<T> = executeRequest(HttpMethod.POST, url, body, headers, responseType)
  ...
  fun <T, R> put(
    ...
    headers: Map<String, String> = emptyMap(),
    responseType: Class<T>,
  ): ResponseEntity<T> = executeRequest(HttpMethod.PUT, url, body, headers, responseType)
  ...
  fun <T> delete(
    ...
    headers: Map<String, String> = emptyMap(),
    responseType: Class<T>,
  ): ResponseEntity<T> = executeRequest(HttpMethod.DELETE, url, null, headers, responseType)
   ...
   */
  fun withDefaultHeaders(headers: Map<String, String>): HttpUtils = HttpUtils(restTemplate, headers, maxRetries, initialBackoffMs, maxBackoffMs, timeoutMs)
  ...
  ): HttpUtils = HttpUtils(restTemplate, defaultHeaders, maxRetries, initialBackoffMs, maxBackoffMs, timeoutMs)
}
 ...
 */
fun httpUtils(restTemplate: RestTemplate): HttpUtils = HttpUtils(restTemplate)
