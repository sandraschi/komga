...
class TextSplitter {
     ...
     */
    fun splitText(text: String, config: RagConfig): List<String> {
        ...
        while (start < text.length) {
            ...
            start = (end - config.chunkOverlap).coerceAtLeast(
    ...
    private fun findSentenceBoundary(text: String, position: Int): Int {
