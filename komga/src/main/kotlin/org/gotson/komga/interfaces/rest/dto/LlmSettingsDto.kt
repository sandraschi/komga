        ...
        fun fromConfig(config: LlmConfig): LlmSettingsDto {
            return LlmSettingsDto(
                ...
                providers = mapOf(
                    ...
                    "lmstudio" to ProviderSettingsDto(
                    ...
                    "google-note-lm" to ProviderSettingsDto(
...
data class LlmSettingsUpdateDto(
    ...
    fun toLlmConfig(current: LlmConfig): LlmConfig {
        return current.copy(
            ...
            openai = this.providers?.get("openai")?.let { update ->
                current.openai.copy(
            ...
            ollama = this.providers?.get("ollama")?.let { update ->
                current.ollama.copy(
            ...
            lmStudio = this.providers?.get("lmstudio")?.let { update ->
            ...
            vllm = this.providers?.get("vllm")?.let { update ->
                current.vllm.copy(
            ...
            googleNoteLm = this.providers?.get("google-note-lm")?.let { update ->
