...
class OmnibusController(
  ...
  fun getVirtualBooks(
    ...
    virtualBookService
      .getVirtualBooksByOmnibus(bookId, pageable)
      .map { it.toDto() }
  ...
  fun getVirtualBookWithOmnibus(
    ...
    val omnibus =
      virtualBookService.getOmnibusForVirtualBook(virtualBookId)
    ...
    return VirtualBookWithOmnibusDto(
      ...
      omnibus =
        VirtualBookDto(
          id = omnibus.id,
          title = omnibus.title,
          sortTitle = omnibus.sortTitle,
          number = omnibus.number,
          numberSort = omnibus.numberSort,
