...
class OmnibusProcessingTaskTest {
    ...
    @Test
    fun `processAllBooks should process all books in the library`() = runBlocking {
        // Given
        val book1 = Book(
            id = "book-1",
            name = "Book 1.epub",
    ...
    @Test
    fun `processAllBooks should handle processing errors for individual books`() = runBlocking {
        // Given
        val book1 = Book(
            id = "book-1",
            name = "Book 1.epub",
