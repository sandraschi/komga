...
allprojects {
  repositories {
    mavenCentral()
    maven { url = uri("https://jitpack.io") } // For GitHub packages

    // DJL repositories - using the snapshot repository for latest versions
    maven {
      url = uri("https://oss.sonatype.org/content/repositories/snapshots/")
      mavenContent {
        includeGroupByRegex("""ai\.djl.*""")
        snapshotsOnly()
      }
    }
    // DJL release repository
    maven {
