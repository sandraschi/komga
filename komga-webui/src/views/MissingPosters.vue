...
export default Vue.extend({
  ...
  computed: {
    headers(): object[] {
      return [
        {text: (this as any).$i18n.tc('common.series', 1).toString(), value: 'seriesTitle', sortable: false},
        {text: (this as any).$i18n.t('common.book').toString(), value: 'metadata.title'},
        {text: (this as any).$i18n.t('media_analysis.media_type').toString(), value: 'media.mediaType'},
        {text: (this as any).$i18n.t('media_analysis.url').toString(), value: 'url'},
