  ...
  computed: {
    thumbnailSizes(): any[] {
      return Object.keys(ThumbnailSizeDto).map(x => ({
        text: (this as any).$t(`enums.thumbnail_size.${x}`),
        value: x,
      }))
    },
    ...
    rememberMeDurationErrors(): string[] {
      ...
      if (!(this as any).$v.form?.rememberMeDurationDays?.$dirty) return errors
      !(this as any).$v?.form?.rememberMeDurationDays?.minValue && errors.push((this as any).$t('validation.one_or_more').toString())
      !(this as any).$v?.form?.rememberMeDurationDays?.required && errors.push((this as any).$t('common.required').toString())
      return errors
    },
    taskPoolSizeErrors(): string[] {
      const errors = [] as string[]
      if (!(this as any).$v.form?.taskPoolSize?.$dirty) return errors
      !(this as any).$v?.form?.taskPoolSize?.minValue && errors.push((this as any).$t('validation.one_or_more').toString())
      !(this as any).$v?.form?.taskPoolSize?.required && errors.push((this as any).$t('common.required').toString())
      return errors
    },
    serverPortErrors(): string[] {
      const errors = [] as string[]
      if (!(this as any).$v.form?.serverPort?.$dirty) return errors;
      (!(this as any).$v?.form?.serverPort?.minValue || !(this as any).$v?.form?.serverPort?.maxValue) && errors.push((this as any).$t('validation.tcp_port').toString())
      return errors
    },
    serverContextPathErrors(): string[] {
      const errors = [] as string[]
      if (!(this as any).$v.form?.serverContextPath?.$dirty) return errors
      !(this as any).$v?.form?.serverContextPath?.contextPath && errors.push((this as any).$t('validation.context_path').toString())
      return errors
    },
    koboPortErrors(): string[] {
      const errors = [] as string[]
      if (!(this as any).$v.form?.koboPort?.$dirty) return errors;
      (!(this as any).$v?.form?.koboPort?.minValue || !(this as any).$v?.form?.koboPort?.maxValue) && errors.push((this as any).$t('validation.tcp_port').toString())
      return errors
    },
  },
  methods: {
    async refreshSettings() {
      const settings = await (this as any).$komgaSettings.getSettings()
      (this as any).$_.merge(this.form, settings)
      ...
      this.form.koboPort = settings.koboPort.databaseSource
      this.form.thumbnailSize = settings.thumbnailSize.databaseSource
      this.form.deleteEmptyCollections = settings.deleteEmptyCollections.databaseSource
      this.form.deleteEmptyReadLists = settings.deleteEmptyReadLists.databaseSource
      this.form.taskPoolSize = settings.taskPoolSize.databaseSource
      this.form.rememberMeDurationDays = settings.rememberMeDurationDays.databaseSource
      this.form.renewRememberMeKey = false
      this.form.koboProxy = settings.koboProxy.databaseSource
    ...
    async saveSettings() {
      ...
      if ((this as any).$v.form?.thumbnailSize?.$dirty && this.form.thumbnailSize !== this.existingSettings.thumbnailSize.databaseSource) {
        newSettings.thumbnailSize = this.form.thumbnailSize
        thumbnailSizeHasChanged = true
      }
      if ((this as any).$v.form?.deleteEmptyCollections?.$dirty) newSettings.deleteEmptyCollections = this.form.deleteEmptyCollections
      if ((this as any).$v.form?.deleteEmptyReadLists?.$dirty) newSettings.deleteEmptyReadLists = this.form.deleteEmptyReadLists
      if ((this as any).$v.form?.taskPoolSize?.$dirty) newSettings.taskPoolSize = this.form.taskPoolSize
      if ((this as any).$v.form?.rememberMeDurationDays?.$dirty) newSettings.rememberMeDurationDays = this.form.rememberMeDurationDays
      if ((this as any).$v.form?.renewRememberMeKey?.$dirty && this.form.renewRememberMeKey) newSettings.renewRememberMeKey = true
      if ((this as any).$v.form?.serverPort?.$dirty) newSettings.serverPort = this.form.serverPort
      if ((this as any).$v.form?.serverContextPath?.$dirty) newSettings.serverContextPath = this.form.serverContextPath
      if ((this as any).$v.form?.koboProxy?.$dirty) newSettings.koboProxy = this.form.koboProxy
      if ((this as any).$v.form?.koboPort?.$dirty) newSettings.koboPort = this.form.koboPort
      if ((this as any).$v.form?.kepubifyPath?.$dirty) newSettings.kepubifyPath = this.form.kepubifyPath
      await (this as any).$komgaSettings.updateSettings(newSettings)
      await (this as any).refreshSettings()
      if (thumbnailSizeHasChanged) {
        this.dialogRegenerateThumbnails = true
      }
    },
    regenerateThumbnails(confirm: boolean) {
      if (confirm) (this as any).$store.dispatch('regenerateThumbnails')
      this.dialogRegenerateThumbnails = false
    },
  },
} as any))
</script>
